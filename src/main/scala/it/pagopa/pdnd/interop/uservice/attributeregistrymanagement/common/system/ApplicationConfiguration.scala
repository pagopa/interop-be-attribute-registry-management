...
object ApplicationConfiguration {
  ...
  lazy val serverPort: Int = config.getInt("uservice-attribute-registry-management.port")

  lazy val jwtAudience: Set[String] =
    config.getStringList("uservice-attribute-registry-management.jwt.audience").asScala.toSet
