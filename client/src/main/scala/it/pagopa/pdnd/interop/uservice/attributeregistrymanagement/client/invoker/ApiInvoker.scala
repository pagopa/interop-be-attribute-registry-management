...
class ApiInvoker(formats: Formats)(implicit system: ActorSystem) extends CustomContentTypes with Json4sSupport {
  import it.pagopa.pdnd.interop.uservice.attributeregistrymanagement.client.invoker.ApiInvoker._
  import it.pagopa.pdnd.interop.uservice.attributeregistrymanagement.client.invoker.ParametersMap._
